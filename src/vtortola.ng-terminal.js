...
.service('prompt', ['terminalConfiguration', function(terminalConfiguration){
    var prompt = function(){
        var me = {};
        var _user, _path, _userPathSeparator, _promptEnd;

        var config = terminalConfiguration.getPromptConfiguration();
        ...
        me.resetUser = function () {
            _user = config && config.user ? config.user : '';
            build();
        }
...
.controller('terminalController', ['$scope','terminalConfiguration','prompt', function ($scope, terminalConfiguration, prompt) {
